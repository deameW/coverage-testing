...
def main():
    ...
    parser.add_argument('--model', dest='modelName', choices=['mnist', 'fashion_mnist', 'sentiment', 'ucf101'], default='sentiment')
    parser.add_argument('--TestCaseNum', dest='TestCaseNum', default='10')
