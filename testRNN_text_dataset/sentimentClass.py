...
class Sentiment:
    ...
    def train_model(self):
        ...
        self.model.fit(self.X_train, self.y_train, validation_data=(self.X_test, self.y_test), epochs=10, batch_size=64)
    ...
    def displayInfo(self,org_text, aug_text, y_test1, y_test2, m, unique_test, r):
        ...
        if adv_n != 0:
            ...
            f = open(os.path.join (r.subdir ('adv_output'), 'org_test_set.txt'), 'a',encoding='utf-8')
            for i in adv_index[0]:
                f.write('\n')
